...
{
    public class Categories(IRepository<Category> repository) : EndpointsAsync.WithRequest<CreateCategoriesRequest>
                                            .WithActionResult<CreateCategoriesResponse>
    {
        ...
        {
            if (request == null)
                throw new ResultException("Category can not be null", StatusCodes.Status400BadRequest);
